...
** Last update Fri Apr 15 21:58:16 2016 Victor Sousa
*/

#include	 	"main.h"

static void 		disp_item_and_quantity(t_prog *prog,
...
static void		disp_hotbar_sprite(t_prog *prog, t_bunny_position *pos)
{
  place_image(create_hitbox(pos->x, pos->y,
			    prog->player->hotbar_sprite->width / 4,
...
void			disp_hotbar(t_prog *prog, t_bunny_position *m_pos)
{
  ...
  while (++i < 12)
	...
	disp_item_and_quantity(prog, pos, m_pos, i);
      x += 40.45;
    }
