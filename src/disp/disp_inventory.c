...
** Last update Fri Apr 15 22:55:52 2016 Victor Sousa
*/
...
{
  place_image(create_hitbox(pos->x, pos->y,
			    prog->player->inv_open_sprite->width / 4,
...
static void		init_stuff(t_prog *prog,
				   t_font *font, t_bunny_position *pos,
...
static void 		disp_item_and_quantity(t_prog *prog, t_font font,
					       int i, t_bunny_position pos)
{
					       ...
					       t_bunny_position *m_pos)
{
  ...
  while (++i < 48)
	...
	{
	  disp_item_and_quantity(prog, font, i, pos);
